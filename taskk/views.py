...
class TaskDetailView(LoginRequiredMixin, DetailView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if comment_form.is_valid():
            ...
            comment.save()
            return redirect('tasks:taskk-detail', pk=comment.task.pk)
        else:
...
class TaskCreateView(LoginRequiredMixin, CreateView):
    ...
    form_class = TaskForm
    success_url = reverse_lazy("tasks:taskk-list")
...
class TaskCompleteView(LoginRequiredMixin, UserIsOwnerMixin, View):
    def post(self, request, *args, **kwargs):
        ...
        task.status = "done"
        task.save()
        return HttpResponseRedirect(reverse_lazy("tasks:taskk-list"))
